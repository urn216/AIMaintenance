...
/**
* An element consisting of a horizontal list of {@code UIComponent}s
*
* @author William Kilty
* @version 0.1
*/
public class ElemListHoriz extends UIElement {

  protected double buffer;
  protected double componentHeight;

  /**
  * Constructor for a horizontal list of {@code UIComponent}s.
  *
  ...
  */
  public ElemListHoriz(Vector2 tL, Vector2 bR, double componentHeight, double buffer, UIComponent[] components, byte transition) {
  ...
  public void draw(Graphics2D g, int screenSizeY, Vector2 tL, Vector2 bR, UIColours.ColourSet c) {
    ...
    float width  = (float) (bR.x - tL.x - buff * (components.length + 1))/components.length;
