...
public class Vector2  // implements Comparable<Vector2>
{
  ...
  /**
   * rounds the {@code Vector2} to the nearest whole number coordinates
   * 
   * @return a {@code Vector2I} with the rounded coordinates in {@code int} format
   */
  ...
  /**
   * casts the {@code Vector2} to a {@code Vector2I}
   * 
   * @return a {@code Vector2I} with the casted coordinates in {@code int} format
   */
